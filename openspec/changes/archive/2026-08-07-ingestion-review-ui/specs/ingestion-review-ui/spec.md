# Spec: Ingestion Review UI

## Capability

Halaman review teks parsing hasil OCR di `apps/web/app/console/ingestion/review/[versionId]/` yang memungkinkan user melihat, mengedit, menyetujui, atau menolak dokumen sebelum dilanjutkan ke tahap chunking.
...
- Multi-user concurrent editing atau locking
- Auto-save / draft teks
- Rich text formatting di editor (bold, heading, list, dll)
- Pagination untuk teks panjang
- Notifikasi real-time perubahan state
