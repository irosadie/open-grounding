...
from app.infrastructure import rag_answer_trace  # noqa: F401  (register ORM records with Base.metadata)
from app.infrastructure import rag_conversations  # noqa: F401  (register ORM records with Base.metadata)
